...
import { Button, IconArrowRight24, IconDownload24, IconError24, InputField } from '@dhis2/ui'
...
const NewDatasetForm = () => {
  ...
  const [dataLayers, setDataLayers] = useState<DatasetLayer[]>([{feature: "", origin: "", dataSource: ""}])
  ...
  return (
    <>
      <div className={styles.formWrapper}>
        <InputField autoComplete="" label='Dataset name' value={datasetName} onChange={(e) => setDatasetName(e.value)} helpText='Name your dataset' placeholder='Malaria incidenc, climate for.. '/>
