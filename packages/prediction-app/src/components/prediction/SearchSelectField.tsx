...
const SearchSelectField = ({feature, onChangeSearchSelectField} : SearchSelectFieldProps) => {
  ...
  const renderList = () => {
    ...
    if(dataItems.length == 0 && query.length == 0){
      return <li className={styles.infoSearchItem}>Start to search by typing</li>
    }
