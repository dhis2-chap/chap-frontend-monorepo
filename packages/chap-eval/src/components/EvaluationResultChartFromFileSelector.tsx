...
const EvaluationResultChartFromFileSelector: React.FC = () => {
    ...
    const [proceededData, setProceededData] = useState<
        EvaluationForSplitPoint[]
    >([])
        ...
        if (file) {
            ...
            reader.onload = (e) => {
                try {
                    ...
                    const withModelName = addModelName(
    ...
    useEffect(() => {
        ...
        const processedData: EvaluationForSplitPoint[] =
            evaluationResultToViewData(allData, realCases)
    ...
    return (
        <div>
            <h2> Upload a file</h2>
            <p>
                Upload a JSON file containing the evaluation results from CHAP
                to view the results.
            </p>
            <p>
            ...
            <p>
                <label>Choose comparison file:</label>
                <input
                    type="file"
                    accept=".json"
